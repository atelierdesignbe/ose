  ...
  <div class="home-intro relative">
    <div class="flex mm-sm:flex-wrap items-start">
      <div class="w-full md:w-[--col-1-3] bg-layout-main theme-dark-blue @sm:py-[60px] @md/lg:py-[80px] px-container flex flex-col @sm:gap-y-[34px] @md/lg:gap-y-[50px] items-start autoscale-children flex-none md:sticky md:top-0">
        ...
        <?php endif; ?>
        <?php echo get_template_part('/components/gradient', null, ['class' => 'absolute bottom-0 left-0 translate-y-[100%] z-[-1] mm-sm:hidden']); ?>
      </div>
            ...
            <div class="flex flex-col @@:gap-y-[32px] *:md:stagger-2">
              <?php foreach($insights as $item): ?>
                <div class="flex flex-col md:flex-row items-start @@:gap-y-[30px] @@:gap-x-[20px] aos animate-fadeinup stagger-delay-200">
                  ...
                  <div class="flex-auto flex flex-col w-full @@:gap-y-4 items-start autoscale-children self-center">
                    <?php if($item['date']): ?>
