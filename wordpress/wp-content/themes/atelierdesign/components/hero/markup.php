...
if ($coverStatus === 'fill') $heroClass = 'absolute bottom-0 right-0 md:h-[--hero-h]';
  ...
  <div class="px-container relative z-10 w-full">
    <div class="grid grid-base">
      <div class="hero-wrapper z-[1] relative col-span-12  @md/lg:py-[130px] flex flex-col @@:gap-y-[16px] <?= $wrapperClass ?>">
        ...
        <p class="paragraph paragraph-primary paragraph-lg autoscale aos animate-fadeinup animate-delay-200 autoscale"><?= $content ?></p>
      </div>
    </div>
  </div>
  <?php if($coverStatus === 'default'): ?>
