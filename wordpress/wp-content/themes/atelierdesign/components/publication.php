...
<a href="<?= get_permalink($id) ?>" class="bg-layout-main theme-light-blue @@:p-[20px] flex">
  <!-- DATE -->
  <!-- CATEGORY -->
  <!-- COVER -->
  <div class="flex-none @sm:w-[88px] @md/lg:w-[158px]">
    <?php echo wp_get_attachment_image($cover['ID'], 'full', null, ['class' => 'object-contain w-full']) ?>
  </div>
  <div class="flex flex-col items-start flex-auto @@:gap-y-[16px] @sm:px-[20px] @md/lg:px-[32px] justify-betwwen">
