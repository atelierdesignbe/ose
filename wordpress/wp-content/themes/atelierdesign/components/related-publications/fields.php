...
$relatedPublicationsFields = [
  wysiwyg('field-group-related-publication-content', ['heading-2xl', 'heading-xl', 'heading-lg'], ['paragraph-lg', 'paragraph-md']),
  // [
  //   'key' => 'field-group-related-publication-link',
  //   'name' => 'link',
  //   'label' => 'Link',
  //   'type' => 'link',
  // ],
  [
    'key' => 'field-group-related-publication-auto',
    'label' => '',
    'name' => 'isCustom',
    'type' => 'true_false',
    'default_value' => 0,
  ...
  [
    'key' => 'field-group-related-publication-themes',
    'label' => 'Themes',
    ...
    'conditional_logic' => [
      [
        [
          'field' => 'field-group-related-publication-auto',
          'operator' => '!=',
          'value' => '1',
        ]
      ]
  ...
  [
    'key' => 'field-group-related-publication-types',
    'label' => 'Types',
    'name' => 'types',
    'type' => 'taxonomy',
  ...
  [
    'key' => 'field-group-related-publication-projects',
    'label' => 'Projects',
    'name' => 'projects',
    'type' => 'taxonomy',
  ...
  [
    'key'   => 'field-group-related-publication-authors',
    'label' => 'Authors',
    'name'  => 'authors',
    'type'  => 'relationship',
    'post_type' => ['author'],
  ...
  [
    'key' => 'field-group-related-publication-custom',
...
$relatedPublicationLayout = [
  'key' => 'layout-related-publications',
  'label' => $icon . ' Related publications',
  'name' => 'related-publications',
  'display' => 'block',
  'sub_fields' => $relatedPublicationsFields,
...
$adwp->add_block_layout('layoutRelatedPublication', $relatedPublicationLayout, 99);