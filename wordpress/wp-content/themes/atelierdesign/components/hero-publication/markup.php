    ...
    <div class="grid grid-base">
      <div class="hero-wrapper z-[1] relative col-span-12  @md/lg:py-[130px] flex flex-col @@:gap-y-[16px] <?= $wrapperClass ?>">
        <div class="flex items-center @@:gap-x-2">
          ...
          <span class="badge badge-primary badge-filled">Project</span>
        </div>
        ...
        <?php if($themes): ?>
          <ul  class="flex items-center flex-wrap @@:gap-x-2 aos animate-fadeinup animate-delay-300">
            <?php foreach($themes as $theme): ?>
              <li class="badge badge-primary badge-filled"><?= $theme->name ?></li>
            <?php endforeach; ?>
          </ul>
        <?php endif; ?>
        <?php if($types): ?>
          <ul  class="flex items-center flex-wrap @@:gap-x-2 aos animate-fadeinup animate-delay-400">
